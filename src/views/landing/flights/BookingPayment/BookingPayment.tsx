      ...
      <div className="second-container">
        ...
        <div className="grid grid-cols-1 items-start mt-6 gap-6 lg:grid-cols-3">
          <div className="lg:col-span-2">
            ...
            <div className="primary-shadow mt-[18px] px-[36px] py-[31px] bg-white rounded-md">
              <p className="text-[#162F7F] text-start text-[20px] font-medium">Payment method</p>
              <div className="flex flex-1 justify-start">
                <p className="primary-shadow mt-5 px-4 py-2 text-base   bg-white rounded-md">Pay With BDT</p>
              </div>
              <div className="flex flex-row gap-2 mt-5">
                <p className="bg-[#F3F6FF] px-4 py-2 rounded-lg">Zahir Uddin</p>
                <p className="bg-[#F3F6FF] px-4 py-2 rounded-lg">january,1993</p>
                <p className="bg-[#F3F6FF] px-4 py-2 rounded-lg">Gender: Male</p>
              </div>
              <div className="mt-5">
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      type="number"
                      placeholder="XXXXXXXXXXXXX45"
                      className="w-full pl-5 py-3 text-gray-500 bg-transparent outline-none border border-[#9D9D9D] focus:border-indigo-600  rounded-lg"
                    />
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-2 mt-2">
                  <div>
                    ...
                    <div className="mt-2">
                      <input
                        type="number"
                        placeholder="12/01/1996"
                        className="w-full pl-5 py-3 text-gray-500 bg-transparent outline-none border border-[#9D9D9D] focus:border-indigo-600  rounded-lg"
                      />
                    </div>
                  </div>
                  <div>
                    <label className="text-gray-600">CVC/CVV</label>
                    <div className="mt-2">
                      <input
                        type="number"
                        placeholder="CVC"
                ...
                <div className="mt-2">
                  <label className="text-gray-600">Card Holder Name</label>
                  <div className="mt-2">
                    <input
                      type="text"
                      placeholder="Aman"
              ...
              <div className="text-xs mt-5">
                <label className="flex items-center cursor-pointer select-none mb-2 gap-1 text-dark">
                  <input type="checkbox" />
                  <p className=" text-[14px] font-[400]"> I want to save the card for future use.</p>
                </label>
                <p className="mb-[28px] text-[14px] font-[400]">
                  By clicking this button you agree to our
                  <span className="text-[#254FD4] px-2">Terms & Conditions</span> and{" "}
                  <span className="text-[#254FD4] px-2">Privacy policy</span>.
                </p>
              </div>
              <Link
                href={"/"}
                className="w-full  max-w-[245px] cursor-pointer py-[8.5px] px-6 flex items-center justify-center rounded-[8.8px] font-[500] bg-[#254FD4] text-[16px] text-white">
                Pay BDT 1,29,245
              </Link>
            </div>
          </div>
