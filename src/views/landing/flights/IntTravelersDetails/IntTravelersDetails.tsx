...
import { LuBaggageClaim, LuUpload } from "react-icons/lu";
import Link from "next/link";
import { useState } from "react";
import { FaAngleDown } from "react-icons/fa6";
import PhoneNumberInput from "@/views/authentication/PhoneNumberInput";
...
export default function IntTravelersDetails() {
  const [activeTab, setActiveTab] = useState<"travelerDetails" | "paymentOptions">("travelerDetails");
  ...
  return (
    <div className=" pt-[65px] pb-16">
      <div className="second-container">
        ...
        <div className="grid grid-cols-1 items-start mt-6 gap-[14px] lg:grid-cols-3">
          <div className="lg:col-span-2">
                ...
                <div className="flex gap-6 lg:gap-16 items-center">
                  <div className="flex flex-col lg:flex-row gap-3 items-center">
                    <button
                      ...
                      className="rounded-md primary-text border bg-white cursor-pointer border-blue-800 flex items-center gap-2  font-[500] text-[12px] p-[6px]">
                      <svg
                        width="10"
                        height="11"
                        viewBox="0 0 10 11"
            ...
            <div className="primary-shadow mt-5 p-7 bg-white rounded-md">
              <div className="flex items-center flex-col justify-center">
                <h2 className="font-[500] dark-b-text text-[20px] text-center">Booking Details</h2>

                <div className="flex items-center mt-5">
                  <button
                    className={`px-5 py-[8px]  cursor-pointer text-[12px] w-full whitespace-nowrap rounded-lg  ${
                      activeTab === "travelerDetails" ? "bg-[#254FD4] text-white z-10" : "bg-[#D5DFFF]"
                    }`}
                    onClick={() => setActiveTab("travelerDetails")}>
                    Traveler Details
                  </button>
                  <button
                    className={`px-5 py-[8px]  cursor-pointer text-[12px] w-full whitespace-nowrap rounded-lg -ml-2 ${
                      activeTab === "paymentOptions" ? "bg-[#254FD4] text-white z-10" : "bg-[#D5DFFF]"
                    }`}
              ...
              <div className="mt-7">
                  ...
                  <div>
                    <div className="lg:px-4">
                      ...
                      <div className="w-full relative mt-4">
                        <input
                          type="text"
                          placeholder="Select From Favorite Travelers"
                          className="px-3 py-2.5 w-full rounded-md outline-none text-[18px] bg-[#ecf0ff]"
                        />
                        <span className="p-1 rounded-full absolute top-1/2 right-5 cursor-pointer transform -translate-y-1/2 flex items-center justify-center place-items-center primary-bg">
                    ...
                    <div className="mt-6">
                      <div className="mt-5 grid grid-cols-5  items-center gap-3 text-base">
                        <div className="w-full relative ">
                          <select className="booking-input cursor-pointer w-full select-wrapper">
                            <option value="mr">Mr</option>
                            <option value="mr">Mrs</option>
                            <option value="mr">Mbbs</option>
                          </select>
                          <span className="icon absolute right-3 text-black top-3">
                            <svg
                              width="20"
                              height="20"
                              viewBox="0 0 24 24"
                        ...
                        <FormControl
                          ...
                          <RadioGroup
                            ...
                            name="gender"
                            value={gen}
                            className="flex gap-3 items-center !text-white flex-row"
                            onChange={handleGen}
                            sx={{
                              "& .MuiFormControlLabel-root": {
                                fontSize: "12px",
                                padding: "2px 18px",
                                border: "1.107px solid #9d9d9d",
                                borderRadius: "4px",
                                margin: "0",

                                "& .MuiTypography-root": {
                                  color: gen === "10" ? "white" : "inherit",
                                },
                              },
                            }}>
                            <FormControlLabel
                      ...
                      <div className="mt-[30px]">
                        <button className="w-full py-[8.5px] px-6 rounded-[8.8px] font-[500] bg-[#2C5FFF] text-[14px] text-white">
                          Its Mandatory to upload copy of your valid{" "}
                          <span className="font-[600]"> Passport and Visa</span>
                        </button>
                      </div>
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mt-4">
                        <div className="flex flex-col gap-1">
                      ...
                      <div className="w-full mt-8 px-4 pb-10 grid grid-cols-1 lg:grid-cols-2 gap-5">
                        <div className="w-full flex-col flex text-center items-center justify-center">
                          ...
                          <button
                            type="button"
                            className="py-[13px] flex cursor-pointer items-center gap-2 font-[500] text-[20px]  justify-center rounded-[14px]  place-items-center bg-[#D5DFFF] w-full">
                            <svg
                              width="34"
                              height="33"
                              viewBox="0 0 34 33"
                      ...
                      <div className="mt-6">
                        <div className="bg-[#EEF1FB] mx-4 p-5 rounded-[8px] flex justify-between gap-4  items-center">
                          <div className="w-full">
                            <p className="text-[18px]">Select Meal Type</p>
                        ...
                        <div className="bg-[#EEF1FB] mt-5 mx-4 p-5 rounded-[8px] flex justify-between gap-4  items-center">
                          <div className="w-full">
                            <p className="text-[18px]">Select Wheel Chair</p>
                            <p className="text-gray-500">Optional</p>
                          </div>
                      ...
                      <div className="flex mt-6 px-5 items-center gap-[32px]">
                        <p className="text-[14px] font-[400] mb-1">Save This Info for future Use</p>
                        <Switch />
                      </div>
                    </div>
                    <div className="w-full mt-14  mb-10 flex items-center text-center max-w-[397px] mx-auto">
                      <button
                        onClick={() => setActiveTab("paymentOptions")}
                        className="w-full cursor-pointer py-[8.5px] px-6 rounded-[8.8px] font-[500] bg-[#254FD4] text-[16px] text-white">
                        Proceed to Payment
                      </button>
                    </div>
                  </div>
                ...
                {activeTab === "paymentOptions" && (
                  <>
                    <PaymentOptions setActiveTab={setActiveTab} />
                  </>
                )}
              </div>
            </div>
      ...
      <ResponsiveDialog
        ...
        setOpen={setIsBag}>
        <div className="">
          <p className="text-[#162F7F]  text-start text-[20px] font-medium">Baggage Details</p>
          <svg
            width="438"
            height="2"
            viewBox="0 0 438 2"
