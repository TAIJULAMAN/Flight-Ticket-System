...
import { MdOutlinePayment, MdOutlineNotificationImportant } from "react-icons/md";
import { PiCoinsFill } from "react-icons/pi";
// Third-party Imports
import PerfectScrollbar from "react-perfect-scrollbar";
import { IoIosPricetag, IoMdNotifications } from "react-icons/io";
// Type Imports
...
const CustomerSideLink = ({ scrollMenu }: Props) => {
  // Hooks
      ...
      <Menu
        ...
        <div className="mt-[80px] w-full flex items-center ">
          <div className="flex items-center justify-between w-full ps-1">
            <button className="flex font-[600] text-[#222222] justify-between items-center cursor-pointer  rounded-md transition-all duration-200 py-2 px-4 w-full bg-transparent text-[16px]">
              Log Out
              <svg
                width="17"
                height="17"
...
export default CustomerSideLink;
