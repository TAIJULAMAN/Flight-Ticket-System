...
export default function CmDate() {
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <div className="relative w-full placeholder:text-[24px] cursor-pointer text-[24px] placeholder:font-[400] font-[400] text-[#808285]  focus:ring-0 outline-none  border-b-[#D9D9D9]  ">
        <DatePicker
          value={date}
          className="text-[24px]"
